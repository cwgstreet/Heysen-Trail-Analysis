...
if os.path.isfile('/Users/carlwgreenstreet/Documents/Git/Heysen-Trail-Analysis/tripidx.csv'):  
    ...
    # create option for headless mode; runs faster & consumes less resources
    ...
    for URL in URLs:
        ...
        # Capture dynamic (inner) html generated by Java Script
        browser.get(target_url) #navigate to the page
        
        # get page data to extract list of tripidx numbers
        ...
        # debug_val_type(JS_dynamic_HTML)  # debug code
